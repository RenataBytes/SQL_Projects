...
SELECT DISTINCT POSTAL_CODE FROM LOCATIONS; --CODIGOS POSTALES DIFERENTES
...
SELECT * FROM DEPARTMENTS;
SELECT DISTINCT MANAGER_ID FROM DEPARTMENTS; --MANAGERS UNICOS
...
SELECT *
FROM DEPARTMENTS
WHERE DEPARTMENT_NAME IN ('Purchasing', 'IT', 'Executive'); --aqui indica el codigo de las profesiones Purchasing, IT, Executive
...
OR (
DEPARTMENT_ID IN (90, 60, 30) --viene de la consulta de arriba.
